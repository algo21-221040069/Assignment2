...
def main():
    ...
    symbols = ['BINANCE.BTCUSDT', 'BINANCE.ETHUSDT', 'BINANCE.BNBUSDT', 'BINANCE.ADAUSDT',
               'BINANCE.XRPUSDT', 'BINANCE.DOGEUSDT', 'BINANCE.LTCUSDT', ]
    ...
    for symbol in symbols:
        ...
        inspect_report(file_name=str(save_path), tax_rate=0, display=False)


if __name__ == '__main__':
    # main()
    compare_reports(pattern='atr*.csv', tax_rate=0)
